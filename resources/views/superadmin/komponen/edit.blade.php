...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" action="/superadmin/komponen/edit/{{$data->id}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Jenis komponen</label>
                ...
                <div class="card-footer">
                    ...
                    <a href="/superadmin/komponen" class="btn btn-danger">Kembali</a>
                </div>
            </form>
            <!-- /.card-body -->
        </div>
